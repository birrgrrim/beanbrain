...
const translations: Record<string, Record<string, string>> = {
	...
	'grinding.manufacturer': { en: 'Manufacturer', uk: 'Виробник' },
	'grinding.manufacturer_placeholder': { en: 'e.g. Eureka', uk: 'напр. Eureka' },
	'grinding.model': { en: 'Model', uk: 'Модель' },
	'grinding.model_placeholder': { en: 'e.g. Mignon Specialita', uk: 'напр. Mignon Specialita' },
	...
	'brewing.manufacturer': { en: 'Manufacturer', uk: 'Виробник' },
	'brewing.manufacturer_placeholder': { en: 'e.g. Gaggia', uk: 'напр. Gaggia' },
	'brewing.model': { en: 'Model', uk: 'Модель' },
	'brewing.model_placeholder': { en: 'e.g. Classic EVO', uk: 'напр. Classic EVO' },
